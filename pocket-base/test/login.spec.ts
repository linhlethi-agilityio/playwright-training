...
test.describe('LO01 - PocketBase Login', () => {
  test.describe('PK001 - Empty Login Fields Validation', () => {
    test('should show validation error for empty login fields', async ({
      loginPage,
      page,
    }) => {
  ...
  test.describe('PK002 - Wrong Login Credentials', () => {
    test('should show error for wrong login credentials', async ({
      loginPage,
      page,
    }) => {
  ...
  test.describe('PK003 - Valid Credentials Login', () => {
